      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="w-full">
            ...
            <input
              ...
              className={`w-full px-4 py-3 border border-gray-300 bg-white text-black placeholder-gray-400 rounded-full ${focusRing} focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors`}
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <input
            ...
            className={`w-full px-4 py-3 border border-gray-300 bg-white text-black placeholder-gray-400 rounded-full ${focusRing} focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors`}
          />
        </div>

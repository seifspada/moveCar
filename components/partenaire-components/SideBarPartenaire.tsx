...
export default function SidebarPartenaire({ 
  isMobileMenuOpen, 
  onMobileMenuToggle,
  isDesktopMenuOpen,
  onDesktopMenuToggle
  ...
  const menuItems = [
         { key: 'Acceuil', icon: Home, label: 'Acceuil', href: '/partenaire/acceuil' },
    { key: 'Demande de mission', icon: Briefcase, label: 'Demande de mission', href: '/partenaire/demande-mission' },
      { key: 'Agences', icon: Briefcase, label: 'Agences', href: '/partenaire/agences' },

...
export const CommentSection: React.FC<CommentSectionProps> = ({ value, onChange }) => (
  <div className="border-2 border-orange-200 rounded-xl p-6 mb-6 bg-gradient-to-br from-orange-50 to-white">
    ...
    <textarea
      ...
      rows={4}
      maxLength={500}
      className="w-full px-4 py-3 border border-gray-300 bg-white text-black placeholder:text-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:outline-none resize-none"
    />

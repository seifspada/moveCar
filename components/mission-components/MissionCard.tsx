...
// ✅ CORRIGÉ : ajout de logs debug pour identifier les valeurs reçues du backend
...
export default function MissionCard({ mission, missionId }: MissionCardProps) {
  ...
  // ✅ CORRIGÉ : logs de debug pour voir exactement ce que reçoit le composant
        ...
        <div className="relative w-full sm:w-24 md:w-28 lg:w-32 
          ...
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28
            ...
            <div className="absolute top-2 right-2 md:top-3 md:right-3">
              <div className={`relative w-5 h-5 md:w-7 md:h-7 rounded-full flex items-center justify-center
                              shadow-md border border-zinc-200 ${carburantInfo.bgColor}`}>
                <Image
          ...
          <div className="grid grid-cols-12 gap-x-2 sm:gap-x-3 md:gap-x-4 gap-y-2 sm:gap-y-3">
            ...
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-zinc-800 rounded-lg px-2 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3
                ...
                {/* ✅ Affiche le label lisible (ex: "Luxe") et non la clé brute ("LUXE") */}
            ...
            <div className="col-span-4 sm:col-span-2">
              <div className="bg-zinc-800 rounded-lg px-2 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3
                              border border-zinc-700 group-hover:border-orange-500/50
                              transition-colors duration-300 h-full flex flex-col justify-center">
                <p className="text-gray-400 text-[9px] sm:text-xs mb-1">Carburant</p>
                {/* ✅ Affiche le label lisible (ex: "Diesel") */}
                <p className={`font-semibold text-xs sm:text-sm leading-tight whitespace-nowrap truncate ${carburantInfo.color}`}>
                  {carburantInfo.label}
                </p>
              </div>
            </div>
